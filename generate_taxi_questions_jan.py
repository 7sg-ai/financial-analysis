...
API_BASE_URL = (
    "http://financial-analysis-api.d2f6dxb4c0dpgkc4.eastus2.azurecontainer.io:8000"
)
...
BACKUP_QUESTIONS = [
    ...
    (
        "fare_analysis",
        "easy",
        "What is the average fare for all trips in January 2024?",
    ),
    (
        "distance_analysis",
        "easy",
        "What is the average distance for all trips in January 2024?",
    ),
    (
        "passenger_analysis",
        "easy",
        "What is the most common number of passengers in January 2024?",
    ),
    ("temporal_analysis", "medium", "What hour has the most pickups in January 2024?"),
    (
        "location_analysis",
        "medium",
        "What is the most frequent pickup location ID in January 2024?",
    ),
    (
        "payment_analysis",
        "easy",
        "How many trips were paid by credit card in January 2024?",
    ),
    (
        "revenue_analysis",
        "medium",
        "What is the total amount collected from all trips in January 2024?",
    ),
    ("tip_analysis", "medium", "What is the total tips collected in January 2024?"),
    (
        "distance_analysis",
        "easy",
        "How many trips were longer than 10 miles in January 2024?",
    ),
    (
        "fare_analysis",
        "easy",
        "What is the highest single fare recorded in January 2024?",
    ),
    (
        "passenger_analysis",
        "easy",
        "How many trips had exactly 1 passenger in January 2024?",
    ),
    (
        "temporal_analysis",
        "medium",
        "How many trips started after 6 PM in January 2024?",
    ),
    (
        "trip_volume",
        "easy",
        "What is the daily average number of trips in January 2024?",
    ),
    (
        "revenue_analysis",
        "medium",
        "What is the average total amount per trip in January 2024?",
    ),
    (
        "location_analysis",
        "medium",
        "What are the top 3 pickup locations in January 2024?",
    ),
    (
        "payment_analysis",
        "easy",
        "What percentage of trips have payment_type = 1 in January 2024?",
    ),
    (
        "tip_analysis",
        "medium",
        "What is the average tip for credit card payments in January 2024?",
    ),
    (
        "distance_analysis",
        "easy",
        "What is the total distance of all trips combined in January 2024?",
    ),
    ("fare_analysis", "easy", "How many trips had a fare over $100 in January 2024?"),
    (
        "temporal_analysis",
        "medium",
        "Which day of week has the least trips in January 2024?",
    ),
    ("aggregation", "medium", "What is the average fare by vendor ID in January 2024?"),
    (
        "comparative_analysis",
        "hard",
        "Compare average fare between yellow and green taxis in January 2024",
    ),
    (
        "revenue_analysis",
        "hard",
        "What is total revenue by payment type in January 2024?",
    ),
    (
        "location_analysis",
        "medium",
        "How many unique dropoff locations exist in January 2024?",
    ),
    (
        "passenger_analysis",
        "easy",
        "What percentage of trips have 2+ passengers in January 2024?",
    ),
...
def call_api(question: str) -> dict:
    ...
    try:
        response = requests.post(
            f"{API_BASE_URL}/api/analyze", json={"question": question}, timeout=120
        )
...
def main():
    ...
    simple_questions = [
        ...
        (
            "fare_analysis",
            "easy",
            "List 5 trips with the highest fares in January 2024",
        ),
        (
            "distance_analysis",
            "easy",
            "Show 10 trips sorted by distance in January 2024",
        ),
        (
            "passenger_analysis",
            "easy",
            "Count trips by passenger count in January 2024",
        ),
        ...
        (
            "revenue_analysis",
            "easy",
            "Show total fare, tip, and total amount sums for January 2024",
        ),
        (
            "aggregation",
            "easy",
            "What is the count of all yellow taxi records in January 2024?",
        ),
        (
            "trip_volume",
            "easy",
            "How many rows are in the yellow_taxi table for January 2024?",
        ),
    ]
