...
create_container() {
    ...
    local create_args=(
        ...
        --environment-variables
            ...
            "API_PORT=8000"
            "LANGFUSE_SECRET_KEY=sk-lf-f708968e-5023-41f6-a4b4-da6b9c6f01c8"
            "LANGFUSE_PUBLIC_KEY=pk-lf-b3bc8526-3a13-44ad-be08-78de2f1f89ea"
            "LANGFUSE_BASE_URL=https://langfuse.7sg.ai"
    )
    if [ -n "$storage_key" ]; then
